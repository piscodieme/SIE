...
export default function TableauConsoEner(props) {
    ...
    const deleteConsoEner =(id)=>{
        HydrocarbureService.deleteConsoEner(id).then((res) =>{
    ...
    <div>
         {
                                            ...
                                            <button type="button" className='myButton' onClick={()=>deleteConsoEner(idProd)}>
                                            Supprimer
                                            </button>
                            ...
                            <tbody className=''>
                                {
                                   line && line.map(
                                        (prod,i) => <tr key={prod.id} className='text-center paddCell'>
                                            <td >{i+1}</td>
                                            <td className='text-center'>{prod.rubrique}</td>
                                            <td className='text-center'>{prod.produit}</td>
                                            <td>{prod.annee}</td>
                                            <td>{prod.unite}</td>
                                            <td>{prod.quantite}</td>
                                            <td>{prod.elecBruteProd}</td>
                                            <td>
