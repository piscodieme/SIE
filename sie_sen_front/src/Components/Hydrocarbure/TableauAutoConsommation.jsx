...
export default function TableauAutoConsommation(props) {
    ...
    const deleteAutoConso =(id)=>{
        HydrocarbureService.deleteAutoConso(id).then((res) =>{
    ...
    <div>
         {
                                            ...
                                            <button type="button" className='myButton' onClick={()=>deleteAutoConso(idProd)}>
                                            Supprimer
                                            </button>
