...
export default function TableauHorsProdEner(props) {
    ...
    const deleteHorsProd =(id)=>{
        industrieService.deleteHorsProd(id).then((res) =>{
   ...
   <div>
    {
                                            ...
                                            <button type="button" className='myButton' onClick={()=>deleteHorsProd(idProd)}>
                                            Supprimer
                                            </button>
